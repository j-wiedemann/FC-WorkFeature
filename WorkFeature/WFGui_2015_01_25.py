...
# Form implementation generated from reading ui file 'WFGui_2015_01_25.ui'
#
# Created: Sun Jan 25 10:01:02 2015
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 335, 622))
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_pointFacePoint.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_point_face_point.setIcon(icon1)
        ...
        self.gridLayout_3.addWidget(self.button_point_face_point, 8, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.button_object_center, 0, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.button_circle_center, 3, 0, 1, 1)
        self.button_object_base_point = QtGui.QPushButton(self.Point_Tab)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_objectBasePoint.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_object_base_point.setIcon(icon4)
        ...
        self.gridLayout_3.addWidget(self.button_object_base_point, 10, 0, 1, 1)
        self.button_line_face_point = QtGui.QPushButton(self.Point_Tab)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_lineFacePoint.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_line_face_point.setIcon(icon5)
        ...
        self.gridLayout_3.addWidget(self.button_line_face_point, 6, 0, 1, 1)
        self.button_click_for_point = QtGui.QPushButton(self.Point_Tab)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_clickPoint.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_click_for_point.setIcon(icon6)
        ...
        self.gridLayout_3.addWidget(self.button_click_for_point, 9, 0, 1, 1)
        self.button_line_center = QtGui.QPushButton(self.Point_Tab)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_centerLinePoint.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_line_center.setIcon(icon7)
        self.button_line_center.setIconSize(QtCore.QSize(32, 32))
        self.button_line_center.setObjectName(_fromUtf8("button_line_center"))
        self.gridLayout_3.addWidget(self.button_line_center, 1, 0, 1, 1)
        self.button_point_line_point = QtGui.QPushButton(self.Point_Tab)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_pointLinePoint.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_point_line_point.setIcon(icon8)
        ...
        self.gridLayout_3.addWidget(self.button_point_line_point, 7, 0, 1, 1)
        self.button_face_center = QtGui.QPushButton(self.Point_Tab)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_centerFacePoint.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_face_center.setIcon(icon9)
        self.button_face_center.setIconSize(QtCore.QSize(32, 32))
        self.button_face_center.setObjectName(_fromUtf8("button_face_center"))
        self.gridLayout_3.addWidget(self.button_face_center, 5, 0, 1, 1)
        self.button_line_extrema = QtGui.QPushButton(self.Point_Tab)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_extremaLinePoint.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_line_extrema.setIcon(icon10)
        ...
        self.gridLayout_3.addWidget(self.button_line_extrema, 2, 0, 1, 1)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_alongLinePoint.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_point_on_line.setIcon(icon11)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_point.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.Point_Tab, icon12, _fromUtf8(""))
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_centerObjectsAxes.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_object_axis.setIcon(icon13)
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_cylinderAxis.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_cylinder_axis.setIcon(icon14)
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_linePlaneAxis.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_line_plane_axis.setIcon(icon15)
        ...
        self.gridLayout.addWidget(self.button_line_plane_axis, 7, 0, 1, 1)
        self.horizontalLayout_2 = QtGui.QHBoxLayout()
        self.horizontalLayout_2.setObjectName(_fromUtf8("horizontalLayout_2"))
        self.button_twopoints_axis = QtGui.QPushButton(self.Axis_Tab)
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_2pointsLine.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_twopoints_axis.setIcon(icon16)
        ...
        self.button_2Planes_axis = QtGui.QPushButton(self.Axis_Tab)
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_2PlanesAxis.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_2Planes_axis.setIcon(icon17)
        self.button_2Planes_axis.setIconSize(QtCore.QSize(32, 32))
        self.button_2Planes_axis.setObjectName(_fromUtf8("button_2Planes_axis"))
        self.gridLayout.addWidget(self.button_2Planes_axis, 8, 0, 1, 1)
        self.button_plane_axis = QtGui.QPushButton(self.Axis_Tab)
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_FaceAxis.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_plane_axis.setIcon(icon18)
        ...
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_twoLinesAxis.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_twolines_axis.setIcon(icon19)
        ...
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_pointLineAxis.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_point_line_axis.setIcon(icon20)
        ...
        self.gridLayout.addWidget(self.button_point_line_axis, 5, 0, 1, 1)
        self.horizontalLayout_7 = QtGui.QHBoxLayout()
        self.horizontalLayout_7.setObjectName(_fromUtf8("horizontalLayout_7"))
        self.button_line_point_axis = QtGui.QPushButton(self.Axis_Tab)
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_linePointAxis.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_line_point_axis.setIcon(icon21)
        ...
        icon22 = QtGui.QIcon()
        icon22.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_baseObjectsAxes.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_object_base_axes.setIcon(icon22)
        ...
        self.gridLayout.addWidget(self.button_object_base_axes, 10, 0, 1, 1)
        spacerItem1 = QtGui.QSpacerItem(20, 40, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.gridLayout.addItem(spacerItem1, 9, 0, 1, 1)
        icon23 = QtGui.QIcon()
        icon23.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_axis.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.Axis_Tab, icon23, _fromUtf8(""))
        ...
        icon24 = QtGui.QIcon()
        icon24.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_clickPlane.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_click_for_plane.setIcon(icon24)
        ...
        icon25 = QtGui.QIcon()
        icon25.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_pointPlanePoint.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_planeandpoint_plane.setIcon(icon25)
        ...
        icon26 = QtGui.QIcon()
        icon26.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_planeLinePlane.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_planeandaxis_plane.setIcon(icon26)
        ...
        icon27 = QtGui.QIcon()
        icon27.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_centerObjectsPlanes.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_object_center_planes.setIcon(icon27)
        ...
        self.gridLayout_9.addWidget(self.button_object_center_planes, 8, 0, 1, 1)
        self.button_axisandpoint_plane = QtGui.QPushButton(self.Plane_Tab)
        icon28 = QtGui.QIcon()
        icon28.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_linePointPlane.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_axisandpoint_plane.setIcon(icon28)
        ...
        icon29 = QtGui.QIcon()
        icon29.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_linePointPlane2.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_axis_point_plane.setIcon(icon29)
        ...
        icon30 = QtGui.QIcon()
        icon30.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_threePointsPlane.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_threepoints_plane.setIcon(icon30)
        ...
        icon31 = QtGui.QIcon()
        icon31.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_plane.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.Plane_Tab, icon31, _fromUtf8(""))
        ...
        icon32 = QtGui.QIcon()
        icon32.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_cylinder.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_cylinder_create.setIcon(icon32)
        ...
        icon33 = QtGui.QIcon()
        icon33.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_cube.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_cube_create.setIcon(icon33)
        ...
        icon34 = QtGui.QIcon()
        icon34.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_boundingBoxes.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_boundingboxes.setIcon(icon34)
        ...
        icon35 = QtGui.QIcon()
        icon35.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_boundingBox.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_boundingbox.setIcon(icon35)
        ...
        icon36 = QtGui.QIcon()
        icon36.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_box.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.Objects_Tab2, icon36, _fromUtf8(""))
        ...
        icon37 = QtGui.QIcon()
        icon37.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_viewAlign.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_alignview.setIcon(icon37)
        ...
        icon38 = QtGui.QIcon()
        icon38.addPixmap(QtGui.QPixmap(_fromUtf8("icons:WF_view.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.View_Tab, icon38, _fromUtf8(""))
        ...
        self.gridLayout_11.addWidget(self.tabWidget_0, 0, 0, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.button_object_center.setToolTip(QtGui.QApplication.translate("Form", "Create a Point at center location of all selected Object(s).", None, QtGui.QApplication.UnicodeUTF8))
...
"", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.button_line_center.setToolTip(QtGui.QApplication.translate("Form", "Create a Point at mid point location of each selected Line(s).", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.button_point_on_line.setToolTip(QtGui.QApplication.translate("Form", "Create a Point on a line at some distance of the extremity  point selected.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.button_2Planes_axis.setToolTip(QtGui.QApplication.translate("Form", "Create an Axis by intersect of 2 Planes.", None, QtGui.QApplication.UnicodeUTF8))
        self.button_2Planes_axis.setText(QtGui.QApplication.translate("Form", "Axis=(Plane,Plane)", None, QtGui.QApplication.UnicodeUTF8))
